          ...
          <div class="col-lg-4 mx-auto">
            ...
            <div class="auto-form-wrapper">
              ...
              <form action="proses/proses_regis.php" method="POST">
                ...
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="masukan nomor hp" name="nohp">
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                      </span>
                ...
                <div class="form-group d-flex justify-content-center">
                  <div class="form-check form-check-flat mt-0">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" checked name="persetujuan"> I agree to the terms
                    </label>
                  </div>
                </div>
