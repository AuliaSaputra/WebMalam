                ...
                <div class="card card-statistics">
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right">
                                <p class="mb-0 text-right">Biodata</p>
                                <div class="fluid-container">
                                    <?php
                                    $jumlah_biodata = mysqli_query($koneksi,"SELECT * FROM biodata");
                                    $jumlah = mysqli_num_rows($jumlah_biodata);
                                    ?>
                                    <h3 class="font-weight-medium text-right mb-0"><?php echo $jumlah ?></h3>
                                </div>
                            </div>
                        </div>
                        <p class="text-muted mt-3 mb-0">
                        ...
                        <div class="fluid-container">
                            <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                                ...
                                <div class="ticket-details col-md-9">
                                    ...
                                    <p class="text-gray ellipsis mb-2">Donec rutrum congue leo eget malesuada. Quisque
                            ...
                            <div class="row ticket-card mt-3">
                                ...
                                <div class="ticket-details col-md-9">
                                    ...
                                    <p class="text-gray ellipsis mb-2">Nulla quis lorem ut libero malesuada feugiat.
                                        Proin eget tortor risus. Lorem ipsum dolor sit amet.</p>
                                    <div class="row text-gray d-md-flex d-none">
                                        <div class="col-4 d-flex">
                                            <small class="mb-0 mr-2 text-muted">Last responded :</small>
                                            <small class="Last-responded mr-2 mb-0 text-muted">3 hours ago</small>
