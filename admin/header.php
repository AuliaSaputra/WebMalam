...
<?php
if($_SESSION['level'] !=('admin'||'operator'||'autor') || empty($_SESSION)){
...
<head>
  ...
  <!-- datatables -->
  <link rel="stylesheet" href="vendors/datatables/Data_Tables/css/jquery.dataTables.css">
  <link rel="stylesheet" href="vendors/datatables/Data_Tables/css/dataTables.bootstrap.css">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
          <li class="nav-item">
            <a href="#" class="nav-link fa fa-newspaper">NEWS
              <span class="badge badge-primary ml-1">New</span>
            </a>
          </li>
          <li class="nav-item active">
            <a href="#" class="nav-link">
              <i class="mdi mdi-elevation-rise"></i>Sport</a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
        ...
        <ul class="nav">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  <p class="profile-name"><?php $_SESSION['username']; ?></p>
                  <div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="basic_elements.php">
              ...
              <span class="menu-title">Biodata User</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="typography.php"> Biodata </a>
                </li>
