                        ...
                        <form class="forms-sample" action="proses/proses_edit.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Username"
                                    name="user" value="<?php echo $data['username']; ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail3" placeholder="No.hp"
                                    name="nohp" value="<?php echo $data['no_hp']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php } else { ?>
                                <select class="form-control" id="exampleFormControlSelect2" name="level">
                                    <option <?php echo ($data['level'] == 'admin') ? 'selected' : '' ?> value="admin">
                                        Admin</option>
                                    <option <?php echo ($data['level'] == 'operator') ? 'selected' : '' ?>
                                        value="operator">Operator</option>
                                    <option <?php echo ($data['level'] == 'autor') ? 'selected' : '' ?> value="autor">
                                        Autor</option>
                                </select>
                                <?php } ?>
