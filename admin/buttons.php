                    ...
                    <div class="card-body">
                      ...
                      while ($data = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                           <a href="buttons.php?aksi=update&id=<?php echo $data ['id_kategori'];?>&nama_kategori=<?php echo $data['nama_kategori'];?>" class="btn btn-warning">Edit</a> 
                                           <a href="buttons.php?aksi=delete&id=<?php echo $data ['id_kategori'];?>" onclick="return confirm('apakah anda yakin ingin menghapus')" class="btn btn-danger">hapus</a> 
                                        </td>
                                    </tr>
                                    <?php
                                     $no++;
                        ...
                        <form class="forms-sample" action="" method="POST">
                          <input type="hidden" name="id_kategori" value="<?php echo $_GET['id'];?>">
                            <div class="form-group">
                                <label for="exampleInputName1">Nama Kategori</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Name"
                                    name="nama_kategori" value="<?php echo $_GET['nama_kategori'];?>" required>
                            </div>


                            <button class="btn btn-success mr-2" type="submit"
                                name="ubah_kategori">Submit</button>
                            <button class="btn btn-light" type="reset">Reset</button>
                        </form>
